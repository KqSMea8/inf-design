...
function getStyle() {
  return `
    ...
    #header,
    #header .infini-select-selection,
    #header .infini-menu {
    ...
    #header #nav .infini-menu-item {
      border-color: transparent;
    }
    #header #nav .infini-menu-submenu {
      border-color: transparent;
    }
    #header #nav .infini-menu-item.hide-in-home-page {
      display: none;
    }
    #header .infini-row > div:last-child .header-lang-button {
      margin-right: 0;
    }
    footer .footer-wrap {
      width: 100%;
