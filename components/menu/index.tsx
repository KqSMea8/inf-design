...
class InternalMenu extends React.Component<InternalMenuProps, MenuState> {
  ...
  // https://github.com/infini-design/infini-design/issues/15966
  componentDidMount() {
    this.mountRafId = raf(() => {
      this.setState({
        mounted: true,
  ...
  // https://github.com/infini-design/infini-design/issues/13104
  ...
  handleTransitionEnd = (e: TransitionEvent) => {
    ...
    // https://github.com/infini-design/infini-design/issues/12864
    const widthCollapsed = e.propertyName === 'width' && e.target === e.currentTarget;

    // Fix SVGElement e.target.className.indexOf is not a function
    // https://github.com/infini-design/infini-design/issues/15699
    ...
    // https://github.com/infini-design/infini-design-pro/issues/2783
  ...
  renderMenu = ({ getPopupContainer, getPrefixCls }: ConfigConsumerProps) => {
    ...
    // https://github.com/infini-design/infini-design/issues/8587
    if (
