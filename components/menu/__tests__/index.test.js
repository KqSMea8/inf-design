...
describe('Menu', () => {
  ...
  it('If has select nested submenu item ,the menu items on the grandfather level should be highlight', () => {
    ...
    expect(wrapper.find('.infini-menu-submenu-selected').length).toBe(1);
  });
  ...
  it('should accept defaultOpenKeys in mode horizontal', () => {
    ...
    expect(
      wrapper
        .find('.infini-menu-sub')
        .at(0)
        .hasClass('infini-menu-hidden'),
    ).not.toBe(true);
  });
  ...
  // https://github.com/infini-design/infini-design/pulls/4677
  // https://github.com/infini-design/infini-design/issues/4692
  ...
  it('should always follow openKeys when inlineCollapsed is switched', () => {
    ...
    expect(
      wrapper
        .find('ul.infini-menu-root')
        .at(0)
        .hasClass('infini-menu-vertical'),
    ).toBe(true);
    expect(wrapper.find('ul.infini-menu-sub').length).toBe(0);
  ...
  it('inlineCollapsed should works well when specify a not existed default openKeys', () => {
    ...
    expect(wrapper.find('.infini-menu-sub').length).toBe(0);
    wrapper.setProps({ inlineCollapsed: true });
    jest.runAllTimers();
    wrapper.update();
    wrapper.simulate('transitionEnd', { propertyName: 'width' });
    wrapper
      .find('.infini-menu-submenu-title')
      .at(0)
      .simulate('mouseEnter');
    jest.runAllTimers();
    wrapper.update();
    expect(
      wrapper
        .find('.infini-menu-submenu')
        .at(0)
        .hasClass('infini-menu-submenu-vertical'),
    ).toBe(true);
    expect(
      wrapper
        .find('.infini-menu-submenu')
        .at(0)
        .hasClass('infini-menu-submenu-open'),
    ).toBe(true);
    expect(
      wrapper
        .find('ul.infini-menu-sub')
  ...
  describe('open submenu when click submenu title', () => {
    ...
    it('inline', () => {
      ...
      expect(wrapper.find('.infini-menu-sub').hostNodes().length).toBe(1);
      expect(
        wrapper
          .find('.infini-menu-sub')
          .hostNodes()
  ...
  it('inline title', () => {
    ...
    const text = wrapper.find('.infini-tooltip-inner').text();
  ...
  it('render correctly when using with Layout.Sider', () => {
    ...
    wrapper.find('.infini-menu-submenu-title').simulate('click');
    wrapper.find('.infini-layout-sider-trigger').simulate('click');
    jest.runAllTimers();
    wrapper.update();
    expect(wrapper.find('.infini-menu-submenu-popup').length).toBe(0);
  });
  ...
  it('MenuItem should not render Tooltip when inlineCollapsed is false', () => {
    ...
    jest.runAllTimers();
    wrapper.update();
    expect(wrapper.find('.infini-tooltip-inner').length).toBe(0);
  });
