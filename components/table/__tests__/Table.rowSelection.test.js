...
describe('Table.rowSelection', () => {
  ...
  // https://github.com/infini-design/infini-design/issues/4020
  ...
  it('click select all selection', () => {
    ...
    dropdownWrapper
      .find('.infini-dropdown-menu-item > div')
      .first()
      .simulate('click');
  ...
  it('fires selection event', () => {
    ...
    expect(dropdownWrapper.find('.infini-dropdown-menu-item').length).toBe(4);
  ...
  it('could hide default selection options', () => {
    ...
    expect(dropdownWrapper.find('.infini-dropdown-menu-item').length).toBe(2);
  });
  ...
  // https://github.com/infini-design/infini-design/issues/4245
  ...
  // https://github.com/infini-design/infini-design/issues/4779
  ...
  it('highlight selected row', () => {
    ...
    expect(
      wrapper
        .find('tbody tr')
        .at(0)
        .hasClass('infini-table-row-selected'),
    ).toBe(true);
  });
  ...
  // https://github.com/infini-design/infini-design/issues/10629
  ...
  // https://github.com/infini-design/infini-design/issues/11042
  ...
  // https://github.com/infini-design/infini-design/issues/11384
  it('should keep item even if in filter', () => {
    ...
    function clickFilter(indexList) {
      indexList.forEach(index => {
        wrapper
          .find('.infini-dropdown-menu-item .infini-checkbox-wrapper')
          .at(index)
          .simulate('click');
      });
      wrapper
        .find('.infini-table-filter-dropdown-btns .infini-table-filter-dropdown-link.confirm')
        .simulate('click');
    }

    function clickItem() {
      wrapper
        .find('tbody .infini-table-selection-column .infini-checkbox-input')
        .at(0)
        .simulate('change', {
          target: { checked: true },
        });
  ...
  it('clear selection className when remove `rowSelection`', () => {
    ...
    expect(wrapper.find('.infini-table-row-selected').length).toBe(1);

    wrapper.setProps({ rowSelection: null });
    expect(wrapper.find('.infini-table-row-selected').length).toBe(0);
  });
});
