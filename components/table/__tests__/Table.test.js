...
describe('Table', () => {
  ...
  it('loading with Spin', async () => {
    ...
    expect(wrapper.find('.infini-spin')).toHaveLength(0);
    expect(wrapper.find('.infini-table-placeholder').text()).not.toEqual('');
    ...
    wrapper.update();
    expect(wrapper.find('.infini-spin')).toHaveLength(1);
  });
