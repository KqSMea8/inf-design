...
class FilterMenu<T> extends React.Component<FilterMenuProps<T>, FilterMenuState<T>> {
  ...
  static getDerivedStateFromProps<T>(nextProps: FilterMenuProps<T>, prevState: FilterMenuState<T>) {
     ...
     * Fixes https://github.com/infini-design/infini-design/issues/10289 and
     * https://github.com/infini-design/infini-design/issues/10209
     */
    if (
  ...
  setNeverShown = (column: ColumnProps<T>) => {
    ...
    const filterBelongToScrollBody = !!closest(rootNode, `.infini-table-scroll`);
    if (filterBelongToScrollBody) {
      // When fixed column have filters, there will be two dropdown menus
      // Filter dropdown menu inside scroll body should never be shown
      // To fix https://github.com/infini-design/infini-design/issues/5010 and
      // https://github.com/infini-design/infini-design/issues/7909
  ...
  handleConfirm = () => {
    ...
    // https://github.com/infini-design/infini-design/issues/12284
