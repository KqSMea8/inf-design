...
| loading | 页面是否加载中 | boolean\|[object](https://ant.design/components/spin-cn/#API) ([更多](https://github.com/infini-design/infini-design/issues/4544#issuecomment-271533135)) | false |
| locale | 默认文案设置，目前包括排序、过滤、空数据文案 | object | filterConfirm: '确定' <br> filterReset: '重置' <br> emptyText: '暂无数据' <br> [默认值](https://github.com/infini-design/infini-design/issues/575#issuecomment-159169511) |
...
| width | 列宽度（[指定了也不生效？](https://github.com/infini-design/infini-design/issues/13825#issuecomment-449889241)） | string\|number | - |
