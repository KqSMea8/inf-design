  ...
  describe('Base', () => {
    describe('trigger ellipsis update', () => {
      ...
      it('should expandable work', () => {
        ...
        wrapper.find('.infini-typography-expand').simulate('click');
      ...
      it('can use css ellipsis', () => {
        ...
        expect(wrapper.find('.infini-typography-ellipsis-single-line').length).toBeTruthy();
      });
    });
