...
describe('Locale Provider', () => {
  ...
  it('should change locale of Modal.xxx', () => {
    ...
    locales.forEach(locale => {
      ...
      const currentConfirmNode = document.querySelectorAll('.infini-modal-confirm')[
        document.querySelectorAll('.infini-modal-confirm').length - 1
      ];
      let cancelButtonText = currentConfirmNode.querySelectorAll(
        '.infini-btn:not(.infini-btn-primary) span',
      )[0].innerHTML;
      let okButtonText = currentConfirmNode.querySelectorAll('.infini-btn-primary span')[0].innerHTML;
