    ...
    return (
      <Form {...formItemLayout} onSubmit={this.handleSubmit}>
        <Form.Item
          label="Plain Text"
        >
          <span className="infini-form-text">China</span>
        </Form.Item>
        <Form.Item
          label="Select"
          hasFeedback
        ...
        >
          ...
          <span className="infini-form-text"> machines</span>
        </Form.Item>
          ...
          <div className="dropbox">
            {getFieldDecorator('dragger', {
              ...
              <Upload.Dragger name="files" action="/upload.do">
                ...
                <p className="infini-upload-hint">Support for a single or bulk upload.</p>
              </Upload.Dragger>
            )}
          </div>
        </Form.Item>
