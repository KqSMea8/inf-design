...
| setFieldsValue | Set the value of a field. (Note: please don't use it in `componentWillReceiveProps`, otherwise, it will cause an endless loop, [reason](https://github.com/infini-design/infini-design/issues/2985)) | ({ \[fieldName\]&#x3A; value }) => void |
...
| validator | custom validate function (Note: [callback must be called](https://github.com/infini-design/infini-design/issues/5155)) | function(rule, value, callback) | - |
...
<style>
.code-box-demo .infini-form:not(.infini-form-inline):not(.infini-form-vertical) {
  max-width: 600px;
}
