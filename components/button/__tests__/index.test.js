...
describe('Button', () => {
  ...
  it('renders Chinese characters correctly in HOC', () => {
    ...
    expect(wrapper.find('.infini-btn').hasClass('infini-btn-two-chinese-chars')).toBe(true);
    wrapper.setProps({
      children: <Text>大按钮</Text>,
    });
    wrapper.update();
    expect(wrapper.find('.infini-btn').hasClass('infini-btn-two-chinese-chars')).toBe(false);
    wrapper.setProps({
  ...
  it('should change loading state instantly by default', () => {
    ...
    expect(wrapper.find('.infini-btn-loading').length).toBe(1);
  });
  ...
  it('should change loading state with delay', () => {
    ...
    const wrapper = mount(<DefaultButton />);
    wrapper.simulate('click');
    expect(wrapper.hasClass('infini-btn-loading')).toBe(false);
  });
