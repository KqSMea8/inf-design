...
More discussion of SVG icon reference to [#10353](https://github.com/infini-design/infini-design/issues/10353).

> ⚠️ About the extra bundle size brought by all SVG icons we imported in 3.9.0, we will provide new API to allow developers importing icons as your need, you can trace [#12011](https://github.com/infini-design/infini-design/issues/12011) for further progress.
>
> Before this, you can use [webpack plugin](https://github.com/Beven91/webpack-infini-icon-loader) from community to chunk the icon file.
