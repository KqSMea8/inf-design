...
describe('Upload', () => {
  ...
  // https://github.com/infini-design/infini-design/issues/14779
  ...
  it('should support linkProps as object', () => {
    ...
    const linkNode = wrapper.find('a.infini-upload-list-item-name');
  ...
  it('should not stop remove when return value of onRemove is false', done => {
    ...
    wrapper.find('div.infini-upload-list-item i.anticon-close').simulate('click');
  ...
  // https://github.com/infini-design/infini-design/issues/14439
  ...
  it('corrent dragCls when type is drag', () => {
    ...
    expect(wrapper.find('.infini-upload-drag-uploading').length).toBe(1);
  });
