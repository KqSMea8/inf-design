...
describe('Popconfirm', () => {
  ...
  it('should show overlay when trigger is clicked', () => {
    ...
    expect(popup.className).toContain('infini-popover-placement-top');
  ...
  it('should be controlled by visible', () => {
    ...
    expect(popconfirm.instance().getPopupDomNode().className).not.toContain('infini-popover-hidden');
    popconfirm.setProps({ visible: false });
    jest.runAllTimers();
    expect(popconfirm.instance().getPopupDomNode().className).toContain('infini-popover-hidden');
    jest.useRealTimers();
  });
  ...
  it('should trigger onConfirm and onCancel', () => {
    ...
    triggerNode.simulate('click');
    popconfirm.find('.infini-btn-primary').simulate('click');
