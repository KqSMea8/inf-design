...
describe('DatePicker', () => {
  ...
  it('should focus trigger input after select date in DatePicker', () => {
    ...
    expect(wrapper.find('.infini-calendar-picker-input').getDOMNode()).toBe(document.activeElement);
  });
  ...
  it('should focus trigger input after select date in RangePicker', () => {
    ...
    expect(wrapper.find('.infini-calendar-picker').getDOMNode()).toBe(document.activeElement);
  });
  ...
  it('should focus trigger input after select date in MonthPicker', () => {
    ...
    openPanel(wrapper);
    wrapper
      .find('.infini-calendar-month-panel-month')
      .first()
      .simulate('click');
    wrapper
      .find('.infini-calendar-month-panel-cell')
      .at(6)
  ...
  it('should not auto focus trigger input when open prop is true in DatePicker', () => {
    ...
    expect(wrapper.find('.infini-calendar-picker-input').getDOMNode()).not.toBe(
  ...
  it('should not auto focus trigger input when open prop is true in RangePicker', () => {
    ...
    const wrapperInput = mount(<Input />);
    wrapperInput.instance().select();
    expect(wrapper.find('.infini-calendar-picker').getDOMNode()).not.toBe(document.activeElement);
  });
