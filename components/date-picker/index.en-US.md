...
If there are special needs (only modifying single component language), Please use the property: local. Example: [default](https://github.com/infini-design/infini-design/blob/master/components/date-picker/locale/example.json).
...
| locale | localization configuration | object | [default](https://github.com/infini-design/infini-design/blob/master/components/date-picker/locale/example.json) |
...
<style>
.code-box-demo .infini-calendar-picker {
  margin: 0 8px 12px 0;
}
</style>
