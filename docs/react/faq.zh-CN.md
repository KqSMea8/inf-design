...
相关 issue：[#3487](https://github.com/infini-design/infini-design/issues/3487) [#3438](https://github.com/infini-design/infini-design/issues/3438)
...
不，我们遵守 Ant Design 设计规范。https://github.com/infini-design/infini-design/issues/1241 。
...
试试 [babel-plugin-import](https://github.com/infini-design/babel-plugin-import)，或者用下面这种方式来按需加载：
...
是的，antd 在设计的时候就是用来开发一个完整的应用的，为了方便，我们覆盖了一些全局样式，现在还不能移除，想要了解更多请追踪这个 issue：https://github.com/infini-design/infini-design/issues/4331 ，或者参考这个教程 [How to avoid modifying global styles?](docs/react/customize-theme#How-to-avoid-modifying-global-styles-?)
...
你应该自行部署 iconfont 文件到你的网络上，参考这个[例子](https://github.com/infini-design/antd-init/tree/7c1a33cadb98f2fd8688fe527dd7f98215b9bced/examples/local-iconfont)。 [#1070](https://github.com/infini-design/infini-design/issues/1070)
...
请阅读这个 [issue](https://github.com/infini-design/infini-design/issues/650#issuecomment-164966511)，或者试试 Linux/Unix。
...
你或许引入了 React 两次。如果你使用 webpack，请将 React & ReactDOM 设置为 external，参见：[#525](https://github.com/infini-design/infini-design/issues/525)。如果你使用其他工具（browserify 等），请阅读它们的文档并将 React & ReactDOM 设置为 external。
