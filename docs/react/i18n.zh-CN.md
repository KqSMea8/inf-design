...
我们还提供了一个使用了 [react-intl](https://github.com/yahoo/react-intl) 和 LocaleProvider 的完整的国际化项目示例：[infini-design/intl-example](https://github.com/infini-design/intl-example)，欢迎参考使用。
