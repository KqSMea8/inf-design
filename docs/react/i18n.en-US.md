...
We also provide you a complete sample of internationalization usage, which is using [react-intl](https://github.com/yahoo/react-intl) and LocaleProvider: [infini-design/intl-example](https://github.com/infini-design/intl-example).
