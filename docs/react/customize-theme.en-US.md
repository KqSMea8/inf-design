...
There are some major variables below, all less variables could be found in [Default Variables](https://github.com/infini-design/infini-design/blob/master/components/style/themes/default.less).
...
Or just [a javascript file path](https://github.com/infini-design/infini-design-pro/blob/b7e7983661eb5e53dc807452e9653e93e74276d4/.webpackrc.js#L18):
...
Currently infini-design is designed as a whole experience and modify global styles (eg `body` etc).
If you need to integrate infini-design as a part of an existing website, it's likely you want to prevent infini-design to override global styles.
...
- If you import styles by specifying the `style` option of [babel-plugin-import](https://github.com/infini-design/babel-plugin-import), change it from `'css'` to `true`, which will import the `less` version of antd.
