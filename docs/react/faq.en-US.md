...
related issue: [#3487](https://github.com/infini-design/infini-design/issues/3487) [#3438](https://github.com/infini-design/infini-design/issues/3438)
...
No, we follow Ant Design specification. https://github.com/infini-design/infini-design/issues/1241
...
Try [babel-plugin-import](https://github.com/infini-design/babel-plugin-import), or import what you need in this way:
...
Yes, antd is designed to develop a complete background application, we override some global styles for styling convenience, and it can't be removed now. More info trace https://github.com/infini-design/infini-design/issues/4331 .
...
You should deploy the iconfont files to your network by following this [example](https://github.com/infini-design/antd-init/tree/7c1a33cadb98f2fd8688fe527dd7f98215b9bced/examples/local-iconfont). [#1070](https://github.com/infini-design/infini-design/issues/1070)
...
Please read this [issue](https://github.com/infini-design/infini-design/issues/650#issuecomment-164966511), or try Linux/Unix.
...
You may import React twice. Set React & ReactDOM as external, if you are using webpack, See [#525](https://github.com/infini-design/infini-design/issues/525). If you are using others (browserify, etc...), please read its documentation and find options which can set React & ReactDOM as external.
